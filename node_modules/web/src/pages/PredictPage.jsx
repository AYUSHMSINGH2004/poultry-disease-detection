...
const PredictPage = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // Directly calling the local FastAPI server
      ...
      if (err.name === 'TypeError' && err.message === 'Failed to fetch') {
        errorMessage = 'Network error: Could not connect to the server at http://127.0.0.1:8000. Ensure your backend is running.';
      }
